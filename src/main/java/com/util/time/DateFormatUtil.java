...
public class DateFormatUtil {
    ...
    // 以空格分隔日期和时间，不带时区信息
    public static final String PATTERN_DEFAULT_ON_MILL = "yyyy-MM-dd HH:mm:ss.SSS";
    ...
    // 以空格分隔日期和时间，不带时区信息
    public static final FastDateFormat DEFAULT_ON_MILL_FORMAT = FastDateFormat.getInstance(PATTERN_DEFAULT_ON_MILL);
    ...
    public static String format(Date date) {
        return formatDate(PATTERN_DEFAULT, date);
    }
     ...
     */
    public static Date parse(String dataString) throws ParseException {
        return pareDate(PATTERN_DEFAULT, dataString);
    }
