...
public class DateFormatUtilTest {
    ...
    public void defaultDateFormat() {
        Date date = new Date(116, 10, 1, 12, 23, 44);
        assertThat(DateFormatUtil.DEFAULT_ON_MILL_FORMAT.format(date)).isEqualTo("2016-11-01 12:23:44.000");
        assertThat(DateFormatUtil.DEFAULT_FORMAT.format(date)).isEqualTo("2016-11-01 12:23:44");
    }

    @Test
    public void formatWithPattern() {
        Date date = new Date(116, 10, 1, 12, 23, 44);
        assertThat(DateFormatUtil.formatDate(DateFormatUtil.PATTERN_DEFAULT_ON_MILL, date))
                .isEqualTo("2016-11-01 12:23:44.000");
        assertThat(DateFormatUtil.formatDate(DateFormatUtil.PATTERN_DEFAULT_ON_MILL, date.getTime()))
                .isEqualTo("2016-11-01 12:23:44.000");
    }
    ...
    public void parseWithPattern() throws ParseException {
        Date date = new Date(116, 10, 1, 12, 23, 44);
        Date resultDate = DateFormatUtil.pareDate(DateFormatUtil.PATTERN_DEFAULT_ON_MILL, "2016-11-01 12:23:44.000");
    ...
    public void formatFriendlyTimeSpanByNow() throws ParseException {
        try {
            Date now = DateFormatUtil.DEFAULT_FORMAT.parse("2016-12-11 23:30:00");

            ClockUtil.useDummyClock(now);

            Date lessOneSecond = DateFormatUtil.DEFAULT_ON_MILL_FORMAT.parse("2016-12-11 23:29:59.500");
            assertThat(DateFormatUtil.formatFriendlyTimeSpanByNow(lessOneSecond)).isEqualTo("刚刚");

            Date lessOneMinute = DateFormatUtil.DEFAULT_ON_MILL_FORMAT.parse("2016-12-11 23:29:55.000");
            assertThat(DateFormatUtil.formatFriendlyTimeSpanByNow(lessOneMinute)).isEqualTo("5秒前");

            Date lessOneHour = DateFormatUtil.DEFAULT_FORMAT.parse("2016-12-11 23:00:00");
            assertThat(DateFormatUtil.formatFriendlyTimeSpanByNow(lessOneHour)).isEqualTo("30分钟前");

            Date today = DateFormatUtil.DEFAULT_FORMAT.parse("2016-12-11 1:00:00");
            assertThat(DateFormatUtil.formatFriendlyTimeSpanByNow(today)).isEqualTo("今天01:00");

            Date yesterday = DateFormatUtil.DEFAULT_FORMAT.parse("2016-12-10 1:00:00");
            assertThat(DateFormatUtil.formatFriendlyTimeSpanByNow(yesterday)).isEqualTo("昨天01:00");

            Date threeDayBefore = DateFormatUtil.DEFAULT_FORMAT.parse("2016-12-09 1:00:00");
