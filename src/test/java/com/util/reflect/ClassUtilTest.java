...
public class ClassUtilTest {
    ...
    @Test
    public void getPageageNameTest(){
        String packageName = "com.util.reflect";
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class)).isEqualTo(packageName);
        assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo(packageName);
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class.getName()))
                .isEqualTo(packageName);
        assertThat(ClassUtil.getPackageName(BClass.class.getName())).isEqualTo(packageName);
    }
    ...
    public void classPresent(){
        ...
        assertThat(ClassUtil.isPresent("com.util.reflect.ClassUtil", ClassUtil.getDefaultClassLoader())).isTrue();
    }
}